...
declare global {
  ...
  interface ObsSceneMappings { scenes: { host: string | null; wheel: string | null; winner: string | null; break: string | null; ending: string | null }; automation: { spinToWheel: boolean; revealToWinner: boolean; acceptToHost: boolean; finishToEnding: boolean } }
