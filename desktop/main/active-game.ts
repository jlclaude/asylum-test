...
export type ActiveGameContext = { gameId: string; sourceUrl: string; broadcastUrl: string; raffleCode: string | null; gameTitle: string | null; locked: boolean };
